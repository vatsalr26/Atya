...
export declare class OpenCallsController {
    private readonly openCallsService;
    constructor(openCallsService: OpenCallsService);
    create(user: {
        profileId: string;
    }, dto: CreateOpenCallDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        title: string;
    ...
    findApplicationsForCall(openCallId: string, user: {
        sub: string;
    }): Promise<({
        applicant: {
            education: {
